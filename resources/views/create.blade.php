                    ...
                    <div class="card mask-custom">
                        <div class="card-body p-6 text-white">
                            ...
                            <div class="text-center pt-3 pb-2">
                                ...
                                <h1 class="display-4 fw-bold">To-doQuie</h1>



                            <form class="form-group" style="text-align: center" action="{{route('createPost')}}"
                                  method="post">
                                @csrf

                                {{ csrf_field() }}
                                <br>
                                    <input type="text" class="form-control" style="text-align: center" name="mission" placeholder="Görevi gir"
                                ...
                                <div>
                                    ...
                                    <select style="background-color: #2563eb" class="mt-3" name="priorty" >
                                        ...
                                        <option value="Önemli">Çok Önemli</option>
                                        <option value="Hedef"> Önemli</option>
                                    </select>
{{--                                    <lu>Roller Deneme</lu>--}}
...
{{--                                    </select>--}}
                                ...
                                <textarea class="form-control" name="comment" cols="10" rows="4"></textarea>
                                @error('comment')
                                <div class="alert alert-danger">
